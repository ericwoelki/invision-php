...
final class CreateReviewReportRequest extends Request implements HasBody
{
    use HasFormBody;
    ...
    public function __construct(
        private readonly CreateReviewReportPayload $payload,
    ) {}

    public function resolveEndpoint(): string
    {
        return "calendar/reviews/{$this->payload->reviewId}/report";
    }
