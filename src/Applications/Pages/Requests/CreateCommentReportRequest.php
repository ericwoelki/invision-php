...
final class CreateCommentReportRequest extends Request implements HasBody
{
    use HasFormBody;
    ...
    public function __construct(
        private readonly CreateCommentReportPayload $payload,
    ) {}

    public function resolveEndpoint(): string
    {
        return "cms/comments/{$this->payload->databaseId}/{$this->payload->commentId}/report";
    }
