 ...
 *
 * @phpstan-type ReviewData array{id: int, item_id: int, author: MemberData, date: string, rating: int, votesTotal: int, votesHelpful: int,
...
final readonly class Review
{
    ...
    public static function fromArray(array $data): Review
    {
        return new self(
            ...
            votesHelpful: $data['votesHelpful'],
